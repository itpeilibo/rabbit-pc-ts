...
<!--            监听复选框的修改,组件内部需要 emit 这个事件,你才能监听-->
            <td><XtxCheckbox @update:modelValue="handleChange(item.skuId,$event)" :modelValue="item.selected" /></td>
            <td>
              <div class="goods">
            ...
            <td class="tc">
              <XtxNumbox @update:modelValue="handleNumChange(item.skuId,$event)" :hasLabel="false" :model-value="item.count" />
            </td>
